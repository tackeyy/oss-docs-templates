...
for opt in --lang --license --copyright-holder --contact-handle --contact-email --description-ja --update-actions --force --dry-run --conduct-contact --code-owners --readme-lang; do
